...
public class ProductBean {
    ...
    public ProductBean(String modelName, int year, String optionsPackage, String color, String motorSize, BigDecimal price, double acceleration, String fuelType, String image, String branch) {
    ...
    public ProductBean(int id, String modelName, int year, String optionsPackage, String color, String motorSize, BigDecimal price, double acceleration, String fuelType, String image, String branch) {
        this.id = id;
        this.modelName = modelName;
        this.year = year;
        this.optionsPackage = optionsPackage;
